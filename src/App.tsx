...
function NavBar (params: NavBarParams) {
  ...
  let [burger, setBurger] = useState<boolean>(false);
  ...
  let navbarButtonClass = "navbar-burger";
  let navbarMenuClass = "navbar-menu";

  if (burger) {
    navbarButtonClass += " is-active";
  ...
  return (
		<nav className="navbar is-primary height-animated" role="navigation" aria-label="main navigation">
			<div className="navbar-brand">
				...
				<a role="button" className={ navbarButtonClass } aria-label="menu" aria-expanded="false" data-target="navbarBasicExample">
